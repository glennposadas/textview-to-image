...
// Glenn: Made this as a scrollview instead of imageview.
public class JLStickerImageView: UIScrollView, UIGestureRecognizerDelegate {
    public var currentlyEditingLabel: JLStickerLabelView!
    var labels: [JLStickerLabelView]!
...
extension JLStickerImageView {
    ...
    public func addLabel() {
        ...
        if let label = self.currentlyEditingLabel {
            adjustsWidthToFillItsContens(label)
...
extension JLStickerImageView {
    @objc func tapOutside() {
        if let _ = currentlyEditingLabel {
...
extension JLStickerImageView: JLStickerLabelViewDelegate {
    ...
    public func labelViewDidClose(_ label: JLStickerLabelView) {
        NotificationCenter.default.post(name: NSNotification.Name.init("labelViewDidClose"), object: nil)
    }
