...
public class JLAttributedTextView: UITextView {
    ...
    public var fontName: String = "Verdana-Bold" {
        didSet {
...
extension JLAttributedTextView {
    override public func caretRect(for position: UITextPosition) -> CGRect {
        ...
        let currentFont: UIFont! = self.font ?? UIFont.systemFont(ofSize: 18.0)
        
        originalRect.size.height = currentFont.pointSize - currentFont.descender
